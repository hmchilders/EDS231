...
Running topicmodels::LDA() produces an S3 object of class lda_topic_model which includes two posterior probability distributions: theta, a distribution over k topics within each document which gives 𝑃(topic\|document)) and beta (in tidytext, but referred to as phi in other places), the distribution over v terms within each topic, where v is our vocabulary and gives 𝑃(token\|topic).
